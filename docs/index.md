...
- For example, type `1.1` `1.2` `1.3` then press "Enter", the app will calculate mean values, which is `1.2`.
...
Terminology based on prostate volume was based on the following:
...
- If Normal height = 4.5 cm, Collapsed height = 3.0 cm
- Height loss = $(4.5 - 3.0) \times 100 / 4.5 = 33.3\%$
